    ...
    <div className='flex justify-between items-center'>
        <div className='flex items-center'>
            ...
            <div>
                ...
                <button className='bg-white text-black hover:bg-gray-300 text-sm font-semibold px-4 py-3 ml-5'>Free S1 Test Drive</button>
                
                <MenuIcon className="ml-5 text-white text-3xl" font5/>
            </div>
    </div>
</div>
