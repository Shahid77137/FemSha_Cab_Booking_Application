    ...
    <footer className='mt-40'>
      <div className='container py-8'>
        <div className='grid grid-cols-1 md:flex justify-around'>
          ...
          <img src="https://s3-ap-southeast-1.amazonaws.com/ola-prod-website/OLA.svg" alt="logo" />
          ...
          <div className='footer-links'>
            ...
            <ul className='mt-4'>
              ...
              <li>
                <a href="#" className='text-gray-400 hover:text-white'>Media Centre</a>
              </li>
            </ul>
          </div>
          <div className='footer-links'>
            <h3 className='text-lg font-semibold'> Customers Support </h3>
            <ul className='mt-4'>
            <li>
      ...
      <div className='bg-grey-800 py-4'>
